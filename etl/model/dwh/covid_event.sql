...
from (select id, datum, 'I' as covid_event_type, vek, pohlavi, okres_lau_kod from stage.ext_osoby
      UNION
      select id, datum, 'R' as covid_event_type, vek, pohlavi, okres_lau_kod from stage.ext_vyleceni
      UNION
      select id, datum, 'D' as covid_event_type, vek, pohlavi, okres_lau_kod from stage.ext_umrti) a
